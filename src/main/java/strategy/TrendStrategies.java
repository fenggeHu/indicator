...
//    public static Action[] MakeMovingChandeForecastOscillatorStrategy(int period) StrategyFunction {
//        return func( final ChartBar asset) []Action {
...
//    public static Action[] MakeKdjStrategy(int rPeriod, int kPeriod, int dPeriod) StrategyFunction {
//        return func( final ChartBar asset) []Action {
...
//    func MakeTrendStrategy(int count) StrategyFunction {
//        return func( final ChartBar asset) []Action {
...
//    func MakeVwmaStrategy(int period) StrategyFunction {
//        return func( final ChartBar asset) []Action {
